...
- (void)strokeInsideWithinRect:(NSRect)clipRect {
    [self strokeInsideWithinRect:clipRect clipPath:nil];
}

- (void)strokeInsideWithinRect:(NSRect)clipRect clipPath:(NSBezierPath *)bezierClipPath
{
